...
export default function CareersEditor() {
    ...
    useEffect(() => { fetch('/api/content/pages/careers').then(r => r.json()).then(setData); }, []);

    async function save() {
        setSaving(true);
        await fetch('/api/content/pages/careers', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data) });
