...
export default function ExportEditor() {
    ...
    useEffect(() => {
        fetch('/api/content/pages/export')
    ...
    async function save() {
        ...
        try {
            const res = await fetch('/api/content/pages/export', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data) });
