...
export default function ChipsyEditor() {
    ...
    useEffect(() => { fetch('/api/content/chipsy').then(r => r.json()).then(setData); }, []);

    async function save() {
        setSaving(true);
        await fetch('/api/content/chipsy', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data) });
    ...
    function addProduct() {
        setData(d => ({
            ...d, products: [...(d.products || []), {
                id: `chipsy_${Date.now()}`, active: true, tone: 'deep',
    ...
    return (
        <div className="p-6 sm:p-8 max-w-3xl space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div><h1 className="text-xl font-bold text-neutral-900">Chipsy Products</h1><p className="text-sm text-neutral-500 mt-0.5">Chipsy catalog page products</p></div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        <select value={p.tone || 'deep'} onChange={e => setProduct(i, 'tone', e.target.value)}
