...
const products = [
    {sku: 'SAR-001', name: 'Cheddar & Sour Cream', nameAr: 'شيدر وكريمة حامضة',  price: 18, stock: 124, status: 'active'},
    {sku: 'SAR-002', name: 'Classic Salted',       nameAr: 'كلاسيك بالملح',      price: 18, stock: 86,  status: 'active'},
    {sku: 'SAR-003', name: 'Salt & Vinegar',       nameAr: 'ملح وخل',            price: 18, stock: 142, status: 'active'},
    {sku: 'SAR-004', name: 'Wavy Original',        nameAr: 'مموج كلاسيك',        price: 18, stock: 48,  status: 'active'},
    {sku: 'SAR-005', name: 'Indian Magic Masala',  nameAr: 'ماسالا هندي',        price: 18, stock: 12,  status: 'low'},
    {sku: 'SAR-006', name: 'Cheddar Classic',      nameAr: 'شيدر كلاسيك',        price: 18, stock: 76,  status: 'active'},
    {sku: 'SAR-007', name: 'Wavy BBQ',             nameAr: 'مموج باربكيو',       price: 18, stock: 0,   status: 'out'},
    {sku: 'SAR-008', name: 'Tangy Salt & Vinegar', nameAr: 'ملح وخل لاذع',       price: 18, stock: 96,  status: 'active'},
    {sku: 'SAR-009', name: 'Wavy Cheddar Ranch',   nameAr: 'مموج شيدر رانش',     price: 18, stock: 34,  status: 'active'},
    {sku: 'SAR-010', name: 'Sour Cream & Onion',   nameAr: 'كريمة حامضة وبصل',   price: 18, stock: 8,   status: 'low'},
];
